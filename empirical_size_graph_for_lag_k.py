...
if __name__ == "__main__":
        ...
        for q in range(len(phi_set)):
            for j in range(len(size_set)):
                ...
                for i in range(50000,50000+replication):
                    ...
                    var_stat_pack = stat_pack_var(y=np.copy(data),lag_number=rho_set[m])[rho_set[m]]
                    ...
                    var_list = [var_ba_real, var_stat_pack] #['Bart', 'Software'] order
    ...
    with open(filename, 'wb') as f:
        ...
        pickle.dump(rho_set, f, protocol=pickle.HIGHEST_PROTOCOL)